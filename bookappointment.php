...
<body id="booking-body">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="booking-nav">
        <div class="container">
            <a class="navbar-brand logo" href="welcome.html" id="booking-logo">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto" id="booking-nav-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="bookappointment.html" id="nav-book"><i class="fas fa-calendar-alt me-1"></i>Book Appointment</a>
                    </li>
                    <li class="nav-item">
                ...
                <a href="bookappointment.html" class="btn btn-primary ms-lg-3 mt-2 mt-lg-0 book-now-btn" id="booking-book-now">
